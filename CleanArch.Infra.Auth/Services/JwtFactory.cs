    ...
    public class JwtFactory : IJwtFactory
    {
        ...
        public async Task<AccessToken> GenerateEncodedToken(string id, string userName)
        {
            ...
            var claims = new[]
            {
                 ...
                 identity.FindFirst(Constants.Constants.JwtClaimIdentifiers.Rol),
                 identity.FindFirst(Constants.Constants.JwtClaimIdentifiers.Id)
            };
        ...
        private static ClaimsIdentity GenerateClaimsIdentity(string id, string userName)
        {
            ...
            {
                new Claim(Constants.Constants.JwtClaimIdentifiers.Id, id),
                new Claim(Constants.Constants.JwtClaimIdentifiers.Rol, Constants.Constants.JwtClaims.ApiAccess)
            });
        }
